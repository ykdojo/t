...
const features = [
  ...
  },
  {
    name: 'View questions',
    summary:
      "Check questions submitted by other users.",
    description:
  ...
  },
  {
    ...
    summary:
      "Discuss potential answers with other users.",
    description:
      "Once you're inside, discuss potential answers to the questions with other users.",
...
export function SecondaryFeatures() {
  return (
    <section
      ...
      className="pt-20 pb-14 sm:pb-20 sm:pt-32 lg:pb-32 bg-white"
    >
      <Container>
